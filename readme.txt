...
This plugin will allow you to specify a custom news feed to display in widget on the admin dashboard. This works in unison with the `Dashboard Custom Feed Admin` plugin which creates the feed.
